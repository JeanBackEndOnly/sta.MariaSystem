...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div class="mx-2">
        <h4><i class="fa-solid fa-file-certificate me-2"></i>SF9 Learner's Progress Report Card</h4>
    </div>
</div>

<div class="row g-3 scroll-sf9">
    <!-- Search and Filters -->
                    ...
                    <tr class="student-row" 
                        ...
                        <td width="15%">
                            <div class="d-flex gap-1 justify-content-center">
                                <a href="/sta.MariaSystem/src/UI-Admin/contents/schoolform9.php?student_id=<?= htmlspecialchars($stu["student_id"]) ?>"
                                   class="btn btn-sm btn-info" title="View SF9 Report Card">
...
.scroll-sf9::-webkit-scrollbar {
    width: 8px;
}

.scroll-sf9::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 4px;
}

.scroll-sf9::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 4px;
}

.scroll-sf9::-webkit-scrollbar-thumb:hover {
    background: #555;
}
</style>