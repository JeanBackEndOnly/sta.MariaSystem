...
<div class="text-white justify-content-between d-flex flex-row col-md-12 col-12  m-0 p-0 bg-danger" style="border-bottom: solid 1px rgba(0,0,0,.2);">
  ...
  <div class="justify-content-end paddingMedia transformMedia d-flex col-md-4 col-4 pe-4">
    <div class="h-100 align-items-center registerNoneDes trf1" style="display: flex;">
      <!-- <i class="fas fa-user-shield me-2"></i> -->
      <span><?php echo ucwords(strtolower($result["lastname"] . ', ' . $result["firstname"])); ?></span>
    </div>

    <button type="button" onclick="LogoutButton()" style="border: none; background: none;" class="trf1">
